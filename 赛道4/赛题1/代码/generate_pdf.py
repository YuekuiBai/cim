...
def create_pdf():
    ...
    story.append(Paragraph('Neural Network Mapping for Analog CIM System', styles['Title_CN']))
    story.append(Paragraph('赛道四：存算设计 - 赛题一', styles['Subtitle']))
    story.append(Spacer(1, 0.5*cm))
    story.append(Paragraph('团队 / Team: HDUer', styles['Subtitle']))
    story.append(Paragraph('成员 / Member: 1', styles['Subtitle']))
    story.append(Paragraph('日期 / Date: 2026-05-10', styles['Subtitle']))
    story.append(PageBreak())

    chapters = [
        ('01_器件原理.md', '第一章 存储器件的工作原理及特性介绍', 'Chapter 1: Storage Device Principles'),
        ('02_神经网络模型.md', '第二章 神经网络模型的介绍', 'Chapter 2: Neural Network Model'),
        ('03_存算阵列规格.md', '第三章 存内计算阵列规格信息', 'Chapter 3: CIM Array Specifications'),
        ('04_网络映射方案.md', '第四章 神经网络映射方案', 'Chapter 4: Network Mapping Scheme'),
        ('05_性能评估.md', '第五章 性能及效率评估', 'Chapter 5: Performance Evaluation'),
